...
-- Agrégation retour actif prepaid par jour et campagne
...
SELECT
    ...
    COUNT(DISTINCT CASE WHEN disponibilite_client = 'Le client a décroché.' AND a_recharge = 1 THEN nd END) AS nb_decroche_et_recharge,
...
FROM {{ ref('int_tts_recharges_prepaid') }}
